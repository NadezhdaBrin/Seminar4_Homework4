...
$works = [
    [
        ...
        "description" => "Описание работы разработчиком. ",
    ],   
     [
        "name" => "Дворник",
        "dateStart" => "Январь 2010",
        "dateEnd" => "Январь 2015",
        "description" => "Описание работы дворником. ",
     ],   
    [
        "name" => "Директор газпромбанка",
        "dateStart" => "Январь 2000",
        "dateEnd" => "Январь 2010",
        "description" => "Описание работы Директор газпромбанка. ",
    ],   
];
?>
<!DOCTYPE html>
